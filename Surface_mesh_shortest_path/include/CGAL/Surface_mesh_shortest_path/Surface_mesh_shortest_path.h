...
private:
  ...
  */
  ...
  void reset_algorithm(bool clearFaceLocations = true)
  {
    ...
    m_closestToVertices.resize(num_vertices(m_graph), Node_distance_pair(null_value, FT(0)));
    m_vertexOccupiers.resize(num_halfedges(m_graph), Node_distance_pair(null_value, FT(0)));
