...
//
// $URL: svn+ssh://sloriot@scm.gforge.inria.fr/svn/cgal/branches/next/Spatial_searching/include/CGAL/Fuzzy_iso_box.h $
// $Id: Fuzzy_iso_box.h 64449 2011-06-28 13:19:40Z sloriot $
// 
//
  ...
  class Fuzzy_iso_box{
	...
	Fuzzy_iso_box(const Point_d& p, const Point_d& q, FT epsilon=FT(0),const SearchTraits& traits_=SearchTraits()) 
	  ...
	  max_begin = construct_it(max);
        ...
        // constructor
	Fuzzy_iso_box(const Iso_box_d& box,int dimension, FT epsilon=FT(0),const SearchTraits& traits_=SearchTraits()) 
	  : traits(traits_), eps(epsilon), dim(dimension)
        {
	  Construct_cartesian_const_iterator_d construct_it=traits.construct_cartesian_const_iterator_d_object();
	  Construct_min_vertex_d construct_min_vertex_d;
	  Construct_max_vertex_d construct_max_vertex_d;
