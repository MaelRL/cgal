    ...
    item_B(-1)
{
  connect(this, SIGNAL(selectionRay(double, double, double, 
          ...
          this, SLOT(setSelectionRay(double, double, double, 
                                     double, double, double)));
  connect(this, SIGNAL(selectedPoint(double, double, double)),
          this, SLOT(setSelectedPoint(double, double, double)));
}
...
void Scene::setSelectedPoint(double x,
                             double y,
                             double z)
{
  Scene_item* item = this->item(selected_item);
  if(item) item->setSelectedPoint(x, y, z);
}
...
#include <CGAL_demo/Scene_find_items.h>
