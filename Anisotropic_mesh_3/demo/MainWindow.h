...
public:
  ...
  Io_plugin_interface* find_loader(const QString& loader_name) const;
  ...
  Scene_item* load_item(QFileInfo fileinfo, Io_plugin_interface*);
...
private:
  ...
  typedef QPair<Plugin_interface*, QString> PluginNamePair;
